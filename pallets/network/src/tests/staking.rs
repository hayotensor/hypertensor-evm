...
use crate::{
    DeactivatedSubnetNodesData, Error, HotkeySubnetNodeId, MaxSubnetNodes, MaxSubnets,
    MinActiveNodeStakeEpochs, NetworkMinStakeBalance, RegisteredSubnetNodesData,
...
#[test]
fn test_deactivate_try_removing_all_stake_error() {
    new_test_ext().execute_with(|| {
        let subnet_name: Vec<u8> = "subnet-name".into();
