...
pub mod pallet {
    ...
    #[pallet::storage]
    pub type SwapQueueOrder<T: Config> =
        StorageValue<_, BoundedVec<u32, ConstU32<1000>>, ValueQuery>;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn remove_subnet(origin: OriginFor<T>, subnet_id: u32) -> DispatchResult {
                ...
                && subnet_delegate_stake_balance < min_subnet_delegate_stake_balance
            {
                ...
                && !in_enactment_period
            {
                // --- If the subnet has not activated itself yet, outside the enactment period
        ...
        #[pallet::weight({0})]
        pub fn set_min_subnet_registration_fee(
            origin: OriginFor<T>,
            value: u128,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_max_subnet_registration_fee(
            origin: OriginFor<T>,
            value: u128,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_subnet_registration_interval(
            origin: OriginFor<T>,
            value: u32,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_min_included_classification_epochs(
            origin: OriginFor<T>,
            value: u32,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_max_included_classification_epochs(
            origin: OriginFor<T>,
            value: u32,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_max_max_subnet_node_penalties(
            origin: OriginFor<T>,
            value: u32,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_min_delegate_stake_percentage(
            origin: OriginFor<T>,
            value: u128,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_max_delegate_stake_percentage(
            origin: OriginFor<T>,
            value: u128,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_min_vast_majority_attestation_percentage(
            origin: OriginFor<T>,
            value: u128,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_min_active_nodes_stake_epochs(
            origin: OriginFor<T>,
            value: u32,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn set_max_overwatch_node_penalties(
            origin: OriginFor<T>,
            value: u32,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
        ...
        #[pallet::weight({0})]
        pub fn collective_blacklist_overwatch_node(
            origin: OriginFor<T>,
            value: T::AccountId,
        ) -> DispatchResult {
            T::SuperMajorityCollectiveOrigin::ensure_origin(origin)?;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn do_register_subnet(
            ...
            // Ensure name is unique
                ...
                subnet_registration_data.subnet_node_queue_epochs >= MinQueueEpochs::<T>::get()
