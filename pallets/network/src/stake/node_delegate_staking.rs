...
impl<T: Config> Pallet<T> {
        ...
        let total_node_delegated_stake_shares =
            match TotalNodeDelegateStakeShares::<T>::get(subnet_id, subnet_node_id) {
                0 => {
                    ...
                    TotalNodeDelegateStakeShares::<T>::mutate(
                        subnet_id,
                        subnet_node_id,
                        |mut n| n.saturating_accrue(Self::MIN_LIQUIDITY),
                    );
                    0
                }
                shares => shares,
    ...
    pub fn do_remove_node_delegate_stake(
        ...
        let (result, node_delegate_stake_to_be_removed, _) =
    ...
    pub fn increase_account_node_delegate_stake_shares(
        ...
        AccountNodeDelegateStakeShares::<T>::mutate(
            (account_id, subnet_id, subnet_node_id),
    ...
    pub fn decrease_account_node_delegate_stake_shares(
        ...
        AccountNodeDelegateStakeShares::<T>::mutate(
            (account_id, subnet_id, subnet_node_id),
            |mut n| n.saturating_reduce(shares),
        );
