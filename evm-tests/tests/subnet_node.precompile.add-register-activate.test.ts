...
// npm test -- -g "test subnet node entry functions"
describe("test subnet node entry functions", () => {
    // init eth part
    ...
    // Status: passing
    // npm test -- -g "testing add subnet node"
    it("testing add subnet node", async () => {
    ...
    // Status: passing
    // npm test -- -g "testing register subnet node"
    it("testing register subnet node", async () => {
    ...
    // Status: passing
    // npm test -- -g "testing activate subnet node"
    it("testing activate subnet node", async () => {
        await registerSubnetNode(
            subnetContract3,
            subnetId,
            wallet3.address,
    ...
    it("testing remove subnet node", async () => {
